...
Deno.serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    if (!userExists) {
      ...
      console.log(`[PASSWORD-RESET] Email not found: ${email.slice(0, 3)}***`);
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto;">
            ...
            <tr>
              <td style="padding: 20px 0;">
                ...
                <p style="margin: 0 0 24px 0;">Use this code to reset your password:</p>
    ...
    console.log(`[PASSWORD-RESET] Code sent to ${email.slice(0, 3)}***`);
